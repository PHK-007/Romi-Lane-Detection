...
public class LeftUTurn extends SequentialCommandGroup{
    public LeftUTurn (double driveSpeed, double turnSpeed, double turnDegree, double blockLength, DistanceUnits unit, Drivetrain drive) {
        addCommands(
