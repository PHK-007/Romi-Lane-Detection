...
import frc.robot.commands.Auton_RobotTour;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // m_chooser.setDefaultOption("Auton Test", new AutonomousTest(Drivetrain.getInstance(), 49, 10, 0.3, 90));
    m_chooser.setDefaultOption("Auton Robot Tour", new Auton_RobotTour(Drivetrain.getInstance(), 47, 15, 0.3, 90));
    // m_chooser.setDefaultOption("Robot Tour", new RobotTour(Drivetrain.getInstance(), 49, 0.4, 0.3, 90));

    m_chooser.addOption("Auton Robot Tour", new Auton_RobotTour(Drivetrain.getInstance(), 47, 15, 0.3, 90));
    // m_chooser.addOption("Auton Test", new AutonomousTest(Drivetrain.getInstance(), 49, 10, 0.3, 90));
