                ...
                * <p>To pass multiple motors per side, use a {@link
                    ...
                    */
                    public void arcadeDrive(double xSpeed, double zRotation) {
                        arcadeDrive(xSpeed, zRotation, true); // Only used in DriveDistance
                    }
                    ...
                    */
                    public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
                        ...
                        double diff = Math.abs(Drivetrain.getInstance().getLeftSpeed() - Drivetrain.getInstance().getRightSpeed());
                        double kP = 0.075;
                        
                        if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.CLOCKWISE && xSpeed > 0) {
                            leftFactor = 1.0;
                            rightFactor = 0.75/*1 - kP * Drivetrain.getInstance().getNetGyroError()*/; // Original 0.95
                        } else if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.COUNTER_CLOCKWISE && xSpeed > 0) {
                            leftFactor = 0.95/*1 - kP * Drivetrain.getInstance().getNetGyroError()*/; // Original: 0.95     Working: 0.7     Kinda working: 1 - 0.05 * Drivetrain.getInstance().getNetGyroError()
                            rightFactor = 1.0;
                        }  else if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.CLOCKWISE && xSpeed < 0) {
                            leftFactor = 0.95/*1 - kP * Drivetrain.getInstance().getNetGyroError()*/; // Original: 0.95     Working: 0.7     Kinda working: 1 - 0.05 * Drivetrain.getInstance().getNetGyroError()
                            rightFactor = 1.0;
                        } else if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.COUNTER_CLOCKWISE && xSpeed < 0) {
                            leftFactor = 1.0;
                        ...
                        m_leftMotor.set(speeds.left * m_maxOutput * leftFactor);
                        m_rightMotor.set(speeds.right * m_maxOutput * rightFactor);
                    ...
                    public void voltageDrive(double leftVoltage, double rightVoltage) {
                        ...
                        if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.CLOCKWISE && leftVoltage > 0) {
                            leftFactor = 1.0;
                            rightFactor = 1 - 1.5 * factor; //1 - kP * Drivetrain.getInstance().getNetGyroError() // Original 0.95
                        } else if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.COUNTER_CLOCKWISE && leftVoltage > 0) {
                            leftFactor = 1 - factor; //1 - kP * Drivetrain.getInstance().getNetGyroError() // Original: 0.95     Working: 0.7     Kinda working: 1 - 0.05 * Drivetrain.getInstance().getNetGyroError()
                            rightFactor = 1.0;
                        }  else if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.CLOCKWISE && leftVoltage < 0) {
                            leftFactor = 1 - factor; //1 - kP * Drivetrain.getInstance().getNetGyroError() // Original: 0.95     Working: 0.7     Kinda working: 1 - 0.05 * Drivetrain.getInstance().getNetGyroError()
                            rightFactor = 1.0;
                        } else if (Drivetrain.getInstance().getCurrentTurnDirection() == TurnDirection.COUNTER_CLOCKWISE && leftVoltage < 0) {
                            leftFactor = 1.0;
                        ...
                        m_leftMotor.setVoltage(leftVoltage * leftFactor);
                        m_rightMotor.setVoltage(rightVoltage * rightFactor);
                        feed();
                    }
